...
object Ticker extends JsonImplicits {

  implicit val TickerEncoder: Encoder[Ticker] = Encoder.instance[Ticker] { v =>
    Json.obj(
  ...
  implicit val TickerDecoder: Decoder[Ticker] = Decoder.instance { hcursor =>
    for {
